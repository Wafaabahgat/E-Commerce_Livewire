<div class="w-full max-w-[85rem] py-10 px-4 mx-auto sm:px-6 lg:px-8">
    <section class="flex items-center font-poppins dark:bg-gray-800 ">
        <div
            ...
            <div>
                ...
                <div
                    class="flex items-stretch justify-start w-full h-full px-4 mb-8 border-b border-gray-200 dark:border-gray-700 md:flex-row xl:flex-col md:space-x-6 lg:space-x-8 xl:space-x-0">

            ...
            <div id="navbar-collapse-with-animation"
                ...
                <div
                    ...
                    <div
                        ...
                        <a wire:navigate
                            class="py-3 {{ request()->is('/') ? 'text-blue-600' : '' }} font-medium  md:py-6 dark:text-blue-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                            href="/" aria-current="page">Home</a>

                        <a wire:navigate
                            class="py-3 font-medium {{ request()->is('categories') ? 'text-blue-600' : '' }} hover:text-gray-400 md:py-6 dark:text-gray-400 dark:hover:text-gray-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                            href="/categories">
                            Categories
                        </a>

                        <a wire:navigate
                            class="py-3 font-medium {{ request()->is('products') ? 'text-blue-600' : '' }} hover:text-gray-400 md:py-6 dark:text-gray-400 dark:hover:text-gray-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                            href="/products">
                            Products
                        </a>

                        <a wire:navigate
                            class="flex {{ request()->is('cart') ? 'text-blue-600' : '' }} items-center py-3 font-medium  hover:text-gray-400 md:py-6 dark:text-gray-400 dark:hover:text-gray-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                            href="/cart">

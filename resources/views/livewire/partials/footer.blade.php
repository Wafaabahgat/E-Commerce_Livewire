    ...
    <div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 lg:pt-20 mx-auto">
      ...
      <div class="grid grid-cols-2 gap-6 md:grid-cols-4 lg:grid-cols-5">
        ...
        <div class="col-span-2">
          ...
          <form>
            <div class="flex flex-col items-center gap-2 p-2 mt-4 bg-white rounded-lg sm:flex-row sm:gap-3 dark:bg-gray-800">
              <div class="w-full">
      ...
      <div class="grid mt-5 sm:mt-12 gap-y-2 sm:gap-y-0 sm:flex sm:justify-between sm:items-center">
        ...
        <!-- Social Brands -->
        <div>
          <a class="inline-flex items-center justify-center w-10 h-10 text-sm font-semibold text-white border border-transparent rounded-lg gap-x-2 hover:bg-white/10 disabled:opacity-50 disabled:pointer-events-none focus:outline-none focus:ring-1 focus:ring-gray-600" href="#">

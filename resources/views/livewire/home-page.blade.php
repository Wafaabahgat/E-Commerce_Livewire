<div>
            ...
            <div class="grid gap-4 md:grid-cols-2 md:gap-8 xl:gap-20 md:items-center">
                    ...
                    <div class="grid grid-cols-2 mt-6 lg:mt-10 gap-x-5">
                        ...
                        <div class="py-5">
                            <div class="flex space-x-1">
                                <svg class="w-4 h-4 text-gray-800 " width="51" height="51" viewBox="0 0 51 51"
                            ...
                            <div class="mt-5">
                                <!-- Star -->
                                <svg class="w-16 h-auto text-gray-800 " width="80" height="27"
                        ...
                        <div class="py-5">
                            <div class="flex space-x-1">
                                ...
                                <svg class="w-4 h-4 text-gray-800 " width="51" height="51"
                            ...
                            <div class="mt-5">
                                <!-- Star -->
                                <svg class="w-16 h-auto text-gray-800 " width="110" height="28"
                ...
                <div class="relative ms-4">
                    ...
                    <div class="absolute bottom-0 start-0">
                        <svg class="w-2/3 h-auto text-white ms-auto" width="630" height="451"
    ...
    {{-- brand --}}
    <x-form.home-form ttl="Browse Popular" spanttl="Brands"
        desc="Lorem ipsum, dolor sit amet consectetur adipisicing elit. Delectus magni eius eaque? Pariatur numquam, odio quod nobis ipsum ex cupiditate?">
        <div class="justify-center max-w-6xl px-4 py-4 mx-auto lg:py-0">
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-4 md:grid-cols-2">
                @foreach ($brands as $brand)
                    <div class="bg-white rounded-lg shadow-md" wire:key='{{ $brand->id }}'>
                        <a href="" class="">
                            <img src="{{ url('storage', $brand->images) }}" alt="{{ $brand->name }}"
    ...
    {{-- categories --}}
    <x-form.home-form className="bg-orange-200" ttl="Browse" spanttl="Categories"
        desc="Lorem ipsum, dolor sit amet consectetur adipisicing elit. Delectus magni eius eaque? Pariatur numquam, odio quod nobis ipsum ex cupiditate?">
    ...
    {{-- customer-review --}}
    <x-form.home-form className="py-14 font-poppins" ttl="Customer" spanttl="Reviews"
        desc="Lorem ipsum, dolor sit amet consectetur adipisicing elit. Delectus magni eius eaque? Pariatur numquam, odio quod nobis ipsum ex cupiditate?">
        <div class="grid grid-cols-1 gap-6 lg:grid-cols-2 container mx-auto">
